...
void GattColorLedServer::init()
{
    ...
    initCharacteristic(pService, BLEUUID("2e252e00-2f8b-4326-91de-26742dda4aa7"), m_RgbValue.getRedValue(),
                                 BLEUUID("2947adbf-b502-4d1d-a9a8-54d9b6b56039"), "red value (0-255)");
    initCharacteristic(pService, BLEUUID("6aeba5cd-4476-43b6-830b-021109ae6dea"), m_RgbValue.getGreenValue(),
                                 BLEUUID("9d317dcf-5987-4d8b-a9eb-a358172a600e"), "green value (0-255)");
    initCharacteristic(pService, BLEUUID("46f27bf3-5b1c-403e-bc20-90934a784e66"), m_RgbValue.getBlueValue(),
